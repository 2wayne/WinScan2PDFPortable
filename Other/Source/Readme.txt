...
user in an INI file next to WinScan2PDFPortable.exe called WinScan2PDFPortable.ini.
...
copy AppNamePortable.ini from this directory to WinScan2PDFPortable.ini next to
WinScan2PDFPortable.exe. The options in the INI file are as follows:
